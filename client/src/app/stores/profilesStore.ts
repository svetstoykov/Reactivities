...
export default class ProfileStore {
    ...
    loadActivities = async (username: string, filter: ProfileActivitiesFilterType) => {
        this.setLoadingActivities(true);
        try {
            const profileActivities = await agent.Profiles.getProfileActivities(username, filter);

            this.setActivities(profileActivities);
        } catch (error) {
            console.log(error);
        } finally {
    ...
    setActivitiesActiveTab = (activeTab: number) => {
        this.activitiesActiveTab = activeTab;
    };

    private setActivities = (activities: ProfileActivityApiModel[]) => {
