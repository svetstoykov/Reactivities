...
import { LoginApiModel } from "../../autogenerated/a-p-i/identity/login-api-model";
import { RegisterApiModel } from "../../autogenerated/a-p-i/identity/register-api-model";
import { ProfileActivityApiModel } from "../../autogenerated/a-p-i/profiles/profile-activity-api-model";
...
const Profiles = {
    ...
    getProfileActivities: (username:string, filter: ProfileActivitiesFilterType) => 
            requests.get<ProfileActivityApiModel[]>(`/profiles/activities?username=${username}&filterTypeId=${filter}`)
};
