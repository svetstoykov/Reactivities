...
namespace Persistence.Migrations
{
    ...
    [Migration("20220731065344_UpdateUserProfileRelationships")]
    partial class UpdateUserProfileRelationships
    {
            ...
            modelBuilder.Entity("Domain.Profiles.Profile", b =>
                {
                    b.HasOne("Application.Common.Identity.Models.User", null)
                        .WithOne()
                        .HasForeignKey("Domain.Profiles.Profile", "Email");

                    b.HasOne("Application.Common.Identity.Models.User", null)
                        .WithOne()
                        .HasForeignKey("Domain.Profiles.Profile", "UserName");
                });
